...
export default component$(() => {
  return (
    ...
    <div class="text-center py-10">
      <h2
        class="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-5xl py-5"
      >
      ...
      <a
        href="#"
        class="mt-8 inline-block rounded-full border border-indigo-600 px-12 text-sm font-medium text-white hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500 py-3 mb-20"
      >
        Get Started
      </a>
    </div>
